...
export default async function DashboardLayout({
  ...
  return (
    <SidebarProvider>
      <div 
        className={cn(
          "flex min-h-screen w-full bg-zinc-50/50 dark:bg-zinc-950",
          isRtl ? "font-arabic" : "font-sans" // Optional: specify Arabic font if you have one
        )} 
        dir={isRtl ? "rtl" : "ltr"}
      >
        <AppSidebar />
        ...
        <SidebarInset className="bg-transparent">
          ...
          <header className="sticky top-0 z-30 flex h-16 shrink-0 items-center justify-between px-6 border-b border-zinc-200/50 dark:border-zinc-800/50 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md transition-all">
